...
@JsonKey(name: 'reset_token') String get resetToken; String get code; String get password;@JsonKey(name: 'confirm_password') String get confirmPassword;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,resetToken,code,password,confirmPassword);

@override
String toString() {
  return 'ResetPasswordRequestModel(resetToken: $resetToken, code: $code, password: $password, confirmPassword: $confirmPassword)';
}
...
@useResult
$Res call({
@JsonKey(name: 'reset_token') String resetToken, String code, String password,@JsonKey(name: 'confirm_password') String confirmPassword
});
...
/// Create a copy of ResetPasswordRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? resetToken = null,Object? code = null,Object? password = null,Object? confirmPassword = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'reset_token')  String resetToken,  String code,  String password, @JsonKey(name: 'confirm_password')  String confirmPassword)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordRequestModel() when $default != null:
return $default(_that.resetToken,_that.code,_that.password,_that.confirmPassword);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'reset_token')  String resetToken,  String code,  String password, @JsonKey(name: 'confirm_password')  String confirmPassword)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequestModel():
return $default(_that.resetToken,_that.code,_that.password,_that.confirmPassword);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'reset_token')  String resetToken,  String code,  String password, @JsonKey(name: 'confirm_password')  String confirmPassword)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequestModel() when $default != null:
return $default(_that.resetToken,_that.code,_that.password,_that.confirmPassword);case _:
  return null;
...
class _ResetPasswordRequestModel implements ResetPasswordRequestModel {
  const _ResetPasswordRequestModel({@JsonKey(name: 'reset_token') required this.resetToken, required this.code, required this.password, @JsonKey(name: 'confirm_password') required this.confirmPassword});
...
/// Create a copy of ResetPasswordRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? resetToken = null,Object? code = null,Object? password = null,Object? confirmPassword = null,}) {

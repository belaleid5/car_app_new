...
/// @nodoc
class _$CarNerstModelCopyWithImpl<$Res>
    implements $CarNerstModelCopyWith<$Res> {
  _$CarNerstModelCopyWithImpl(this._self, this._then);

  final CarNerstModel _self;
  final $Res Function(CarNerstModel) _then;
...
as LocationModel,averageRate: null == averageRate ? _self.averageRate : averageRate // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [CarNerstModel].
extension CarNerstModelPatterns on CarNerstModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CarNerstModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CarNerstModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CarNerstModel value)  $default,){
final _that = this;
switch (_that) {
case _CarNerstModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CarNerstModel value)?  $default,){
final _that = this;
switch (_that) {
case _CarNerstModel() when $default != null:
return $default(_that);case _:
...
/// @nodoc
abstract mixin class _$CarNerstModelCopyWith<$Res> implements $CarNerstModelCopyWith<$Res> {
  factory _$CarNerstModelCopyWith(_CarNerstModel value, $Res Function(_CarNerstModel) _then) = __$CarNerstModelCopyWithImpl;
@override @useResult
$Res call({
 int id, String name, String description, int owner,@JsonKey(name: 'first_image') String firstImage, List<CarImageModel> images,@JsonKey(name: 'car_type') String carType, BrandModel brand, ColorModel color,@JsonKey(name: 'car_features') List<CarFeatureModel> carFeatures,@JsonKey(name: 'seating_capacity') String seatingCapacity, LocationModel location,@JsonKey(name: 'average_rate') int averageRate,@JsonKey(name: 'is_for_rent') bool isForRent,@JsonKey(name: 'daily_rent') String? dailyRent,@JsonKey(name: 'weekly_rent') String? weeklyRent,@JsonKey(name: 'monthly_rent') String? monthlyRent,@JsonKey(name: 'yearly_rent') String? yearlyRent,@JsonKey(name: 'is_for_pay') bool isForPay, String? price,@JsonKey(name: 'available_to_book') bool availableToBook, List<ReviewModel> reviews,@JsonKey(name: 'reviews_count') int reviewsCount,@JsonKey(name: 'reviews_avg') double reviewsAvg
});
...
/// @nodoc
class __$CarNerstModelCopyWithImpl<$Res>
    implements _$CarNerstModelCopyWith<$Res> {
  __$CarNerstModelCopyWithImpl(this._self, this._then);

  final _CarNerstModel _self;
  final $Res Function(_CarNerstModel) _then;

...
import 'package:car_app_new/features/car_feature/search/presention/widget/car_footer_card_recommendtion_for_you.dart';
import 'package:flutter/material.dart';

class CarCardRecommendtionForYou extends StatelessWidget {
  const CarCardRecommendtionForYou({
    super.key,
    required this.cars,
  });
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  verticalSpace(10),
                  CarFooterCardRecommendtionForYou(
                    price: cars.price,
                  ),
                ],
              ),

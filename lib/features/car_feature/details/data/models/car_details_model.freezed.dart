...
/// @nodoc
abstract mixin class $CarDetailsModelCopyWith<$Res>  {
  factory $CarDetailsModelCopyWith(CarDetailsModel value, $Res Function(CarDetailsModel) _then) = _$CarDetailsModelCopyWithImpl;
@useResult
$Res call({
 int id, String name, String description, OwnerModel owner,@JsonKey(name: 'first_image') String firstImage, List<CarImageModel> images,@JsonKey(name: 'car_type') String carType, BrandModel brand, ColorModel color,@JsonKey(name: 'car_features') List<CarFeatureModel> carFeatures,@JsonKey(name: 'seating_capacity') String seatingCapacity, LocationHomeModel location,@JsonKey(name: 'average_rate') int averageRate,@JsonKey(name: 'is_for_rent') bool isForRent,@JsonKey(name: 'daily_rent') String? dailyRent,@JsonKey(name: 'weekly_rent') String? weeklyRent,@JsonKey(name: 'monthly_rent') String? monthlyRent,@JsonKey(name: 'yearly_rent') String? yearlyRent,@JsonKey(name: 'is_for_pay') bool isForPay, String? price,@JsonKey(name: 'available_to_book') bool availableToBook, List<ReviewModel> reviews,@JsonKey(name: 'reviews_count') int reviewsCount,@JsonKey(name: 'reviews_avg') double reviewsAvg
});


$OwnerModelCopyWith<$Res> get owner;$BrandModelCopyWith<$Res> get brand;$ColorModelCopyWith<$Res> get color;

}
/// @nodoc
class _$CarDetailsModelCopyWithImpl<$Res>
    implements $CarDetailsModelCopyWith<$Res> {
  _$CarDetailsModelCopyWithImpl(this._self, this._then);

  final CarDetailsModel _self;
  final $Res Function(CarDetailsModel) _then;
...
as OwnerModel,firstImage: null == firstImage ? _self.firstImage : firstImage // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [CarDetailsModel].
extension CarDetailsModelPatterns on CarDetailsModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CarDetailsModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CarDetailsModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CarDetailsModel value)  $default,){
final _that = this;
switch (_that) {
case _CarDetailsModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CarDetailsModel value)?  $default,){
final _that = this;
switch (_that) {
case _CarDetailsModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String description,  OwnerModel owner, @JsonKey(name: 'first_image')  String firstImage,  List<CarImageModel> images, @JsonKey(name: 'car_type')  String carType,  BrandModel brand,  ColorModel color, @JsonKey(name: 'car_features')  List<CarFeatureModel> carFeatures, @JsonKey(name: 'seating_capacity')  String seatingCapacity,  LocationHomeModel location, @JsonKey(name: 'average_rate')  int averageRate, @JsonKey(name: 'is_for_rent')  bool isForRent, @JsonKey(name: 'daily_rent')  String? dailyRent, @JsonKey(name: 'weekly_rent')  String? weeklyRent, @JsonKey(name: 'monthly_rent')  String? monthlyRent, @JsonKey(name: 'yearly_rent')  String? yearlyRent, @JsonKey(name: 'is_for_pay')  bool isForPay,  String? price, @JsonKey(name: 'available_to_book')  bool availableToBook,  List<ReviewModel> reviews, @JsonKey(name: 'reviews_count')  int reviewsCount, @JsonKey(name: 'reviews_avg')  double reviewsAvg)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CarDetailsModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String description,  OwnerModel owner, @JsonKey(name: 'first_image')  String firstImage,  List<CarImageModel> images, @JsonKey(name: 'car_type')  String carType,  BrandModel brand,  ColorModel color, @JsonKey(name: 'car_features')  List<CarFeatureModel> carFeatures, @JsonKey(name: 'seating_capacity')  String seatingCapacity,  LocationHomeModel location, @JsonKey(name: 'average_rate')  int averageRate, @JsonKey(name: 'is_for_rent')  bool isForRent, @JsonKey(name: 'daily_rent')  String? dailyRent, @JsonKey(name: 'weekly_rent')  String? weeklyRent, @JsonKey(name: 'monthly_rent')  String? monthlyRent, @JsonKey(name: 'yearly_rent')  String? yearlyRent, @JsonKey(name: 'is_for_pay')  bool isForPay,  String? price, @JsonKey(name: 'available_to_book')  bool availableToBook,  List<ReviewModel> reviews, @JsonKey(name: 'reviews_count')  int reviewsCount, @JsonKey(name: 'reviews_avg')  double reviewsAvg)  $default,) {final _that = this;
switch (_that) {
case _CarDetailsModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String description,  OwnerModel owner, @JsonKey(name: 'first_image')  String firstImage,  List<CarImageModel> images, @JsonKey(name: 'car_type')  String carType,  BrandModel brand,  ColorModel color, @JsonKey(name: 'car_features')  List<CarFeatureModel> carFeatures, @JsonKey(name: 'seating_capacity')  String seatingCapacity,  LocationHomeModel location, @JsonKey(name: 'average_rate')  int averageRate, @JsonKey(name: 'is_for_rent')  bool isForRent, @JsonKey(name: 'daily_rent')  String? dailyRent, @JsonKey(name: 'weekly_rent')  String? weeklyRent, @JsonKey(name: 'monthly_rent')  String? monthlyRent, @JsonKey(name: 'yearly_rent')  String? yearlyRent, @JsonKey(name: 'is_for_pay')  bool isForPay,  String? price, @JsonKey(name: 'available_to_book')  bool availableToBook,  List<ReviewModel> reviews, @JsonKey(name: 'reviews_count')  int reviewsCount, @JsonKey(name: 'reviews_avg')  double reviewsAvg)?  $default,) {final _that = this;
switch (_that) {
case _CarDetailsModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.owner,_that.firstImage,_that.images,_that.carType,_that.brand,_that.color,_that.carFeatures,_that.seatingCapacity,_that.location,_that.averageRate,_that.isForRent,_that.dailyRent,_that.weeklyRent,_that.monthlyRent,_that.yearlyRent,_that.isForPay,_that.price,_that.availableToBook,_that.reviews,_that.reviewsCount,_that.reviewsAvg);case _:
  return null;
...
/// @nodoc
abstract mixin class _$CarDetailsModelCopyWith<$Res> implements $CarDetailsModelCopyWith<$Res> {
  factory _$CarDetailsModelCopyWith(_CarDetailsModel value, $Res Function(_CarDetailsModel) _then) = __$CarDetailsModelCopyWithImpl;
@override @useResult
$Res call({
 int id, String name, String description, OwnerModel owner,@JsonKey(name: 'first_image') String firstImage, List<CarImageModel> images,@JsonKey(name: 'car_type') String carType, BrandModel brand, ColorModel color,@JsonKey(name: 'car_features') List<CarFeatureModel> carFeatures,@JsonKey(name: 'seating_capacity') String seatingCapacity, LocationHomeModel location,@JsonKey(name: 'average_rate') int averageRate,@JsonKey(name: 'is_for_rent') bool isForRent,@JsonKey(name: 'daily_rent') String? dailyRent,@JsonKey(name: 'weekly_rent') String? weeklyRent,@JsonKey(name: 'monthly_rent') String? monthlyRent,@JsonKey(name: 'yearly_rent') String? yearlyRent,@JsonKey(name: 'is_for_pay') bool isForPay, String? price,@JsonKey(name: 'available_to_book') bool availableToBook, List<ReviewModel> reviews,@JsonKey(name: 'reviews_count') int reviewsCount,@JsonKey(name: 'reviews_avg') double reviewsAvg
});
...
@override $OwnerModelCopyWith<$Res> get owner;@override $BrandModelCopyWith<$Res> get brand;@override $ColorModelCopyWith<$Res> get color;

}
/// @nodoc
class __$CarDetailsModelCopyWithImpl<$Res>
    implements _$CarDetailsModelCopyWith<$Res> {
  __$CarDetailsModelCopyWithImpl(this._self, this._then);

  final _CarDetailsModel _self;
  final $Res Function(_CarDetailsModel) _then;

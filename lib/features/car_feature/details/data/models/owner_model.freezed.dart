...
@override
String toString() {
  return 'OwnerModel(id: $id, fullName: $fullName, email: $email, phone: $phone, phoneIsVerified: $phoneIsVerified, balance: $balance, nationalId: $nationalId, dateOfBirth: $dateOfBirth, country: $country, location: $location)';
}
...
class _OwnerModel implements OwnerModel {
  const _OwnerModel({required this.id, @JsonKey(name: 'full_name') this.fullName = '', this.email = '', this.phone = '', @JsonKey(name: 'phone_is_verified') this.phoneIsVerified = false, this.balance = 0.0, @JsonKey(name: 'national_id') this.nationalId, @JsonKey(name: 'date_of_birth') this.dateOfBirth, this.country, this.location});

...
import 'package:car_app_new/features/car_feature/details/data/models/owner_model.dart';
...
@freezed
sealed class CarDetailsModel with _$CarDetailsModel {
  const factory CarDetailsModel({
    required int id,

...
mixin _$ReviewModel {
 ...
 int get id; String get username; String get review;@JsonKey(name: 'user_image') String get userImage; int get rate;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,username,review,userImage,rate);

@override
String toString() {
  return 'ReviewModel(id: $id, username: $username, review: $review, userImage: $userImage, rate: $rate)';
}
...
@useResult
$Res call({
 int id, String username, String review,@JsonKey(name: 'user_image') String userImage, int rate
});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? username = null,Object? review = null,Object? userImage = null,Object? rate = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String username,  String review, @JsonKey(name: 'user_image')  String userImage,  int rate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.username,_that.review,_that.userImage,_that.rate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String username,  String review, @JsonKey(name: 'user_image')  String userImage,  int rate)  $default,) {final _that = this;
switch (_that) {
case _ReviewModel():
return $default(_that.id,_that.username,_that.review,_that.userImage,_that.rate);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String username,  String review, @JsonKey(name: 'user_image')  String userImage,  int rate)?  $default,) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.username,_that.review,_that.userImage,_that.rate);case _:
  return null;
...
class _ReviewModel implements ReviewModel {
  const _ReviewModel({required this.id, required this.username, required this.review, @JsonKey(name: 'user_image') required this.userImage, required this.rate});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? username = null,Object? review = null,Object? userImage = null,Object? rate = null,}) {

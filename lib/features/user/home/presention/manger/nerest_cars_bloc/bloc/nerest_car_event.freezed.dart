...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function()?  loadMore,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function()  loadMore,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function()?  loadMore,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _LoadMore() when loadMore != null:
return loadMore();case _:
...
class _Started implements NerestCarsEvent {
  const _Started();
...
@override
String toString() {
  return 'NerestCarsEvent.started()';
}
...
class _LoadMore implements NerestCarsEvent {
  const _LoadMore();
...
@override
String toString() {
  return 'NerestCarsEvent.loadMore()';
}

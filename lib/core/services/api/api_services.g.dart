...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://qent.azurewebsites.net/api';
  }
  ...
  @override
  Future<UserResponseModel> login(LoginRequestModel loginRequestBody) async {
    ...
    final _options = _setStreamType<UserResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/auth/login/',
  ...
  Future<UserResponseModel> register(
    ...
    final _options = _setStreamType<UserResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/auth/register/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<LocationResponseModel> getLocations() async {
    ...
    final _options = _setStreamType<LocationResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/public/register_locations',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ForgotPasswordResponseModel> forgotPassword(String email) async {
    ...
    final _options = _setStreamType<ForgotPasswordResponseModel>(
      Options(
          ...
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/auth/forgot_password/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<MessageResponseModel> resetPassword(
    ...
    final _options = _setStreamType<MessageResponseModel>(
      Options(
          ...
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/auth/reset_password/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<CarsResponseModel> getCars({int? page, int? limit}) async {
    final _extra = <String, dynamic>{};
    ...
    final _options = _setStreamType<CarsResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/cars',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<BrandsResponseModel> getBrands({int? page}) async {
    final _extra = <String, dynamic>{};
    ...
    final _options = _setStreamType<BrandsResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/brands',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<CarsNerestResponseModel> getNerestCars({int? page, int? limit}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CarsNerestResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/cars/nearest',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CarsNerestResponseModel _value;
    try {
      _value = CarsNerestResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<CarDetailsModel> getCarDetails({required String carId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CarDetailsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://qent.azurewebsites.net/api/cars/${carId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
